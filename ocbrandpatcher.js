  ...
  function patchBody() {
    ...
    var walker = document.createTreeWalker(document.body, NodeFilter.SHOW_TEXT, {
      acceptNode: function (n) {
        ...
        // matched fragment. Accept any text node containing "We are a licensed P" -- the
        // about-hero sentence gets fragmented across inline markup (separate text nodes
        // for "We are a licensed P", "&", "C agency based in", "Johns Creek", ", Georgia.").
        if (/We are a licensed P/i.test(n.nodeValue)) return NodeFilter.FILTER_ACCEPT;
