...
// === ocwgthealer.js ===
(function(){var GOOD_SHA='8589056ffb28b0e51c6b89b17161bd6fcd6ab976';function heal(){var r=document.getElementById('oc-widget-root');if(r&&r.getAttribute('data-wgt-ver')==='2.17.0')return;var bad=document.querySelectorAll('script[src*="ocreposit"][src*="ocwidget.js"]');var goodLoaded=false;bad.forEach(function(s){if(s.src.indexOf(GOOD_SHA)>=0)goodLoaded=true;});if(goodLoaded)return;if(r)r.parentNode.removeChild(r);bad.forEach(function(s){if(s.src.indexOf(GOOD_SHA)<0)s.parentNode.removeChild(s);});var s=document.createElement('script');s.src='https://cdn.jsdelivr.net/gh/manand2020/ocreposit@'+GOOD_SHA+'/ocwidget.js?v=2.17.0&r='+Date.now();s.async=true;document.head.appendChild(s);}if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',function(){setTimeout(heal,800);});}else{setTimeout(heal,800);}setTimeout(heal,3500);setTimeout(heal,6000);})();
