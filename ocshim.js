...
//   "Got it. An Olive Cover team member will follow up shortly. For anything urgent,
//   call (678) 888-1011 or email askolive@olivecover.com." Drops robotic "saved" phrasing.
//   Note: this fallback fires when /chat/send returns non-200 (Cloud Function issue);
//   the AI-reply-from-success path isn't affected. Underlying Cloud Function reliability
//   is OC Tech's responsibility.
// v1.10.47 (2026-05-24): /about hero full-bleed v3 -- root cause was inside ocstylefixes.
//   Found: fixHero() inside the ocstylefixes IIFE was running AFTER ocabouthero and setting
//   max-width:1180px + margin:0 auto on the section. Patched fixHero() to set max-width:none
//   + width:100% + margin:0 instead. Now no module forces the section narrow.
...
//   image max-height 110px (was 140), zero card-gap. Aggressive density for scan-style hub.
